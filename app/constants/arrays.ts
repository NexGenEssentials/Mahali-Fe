...
export const AboutService = [
  {
    ...
    description:
      "With roots dating back to 2023, our journey began with our founder whose passion for exploration as a tour guide inspired the founding of Mahali Africa Adventures. Over the years, we have grown into a trusted name in travel, tourism, and hospitality delivering unforgettable experiences.",
    image: mahali,
  },
  {
    title: "Locally Owned",
  ...
  },
  {
    ...
    description:
      "Our excellence has been recognized regionally with prestigious wins, affirming our commitment to delivering unparalleled travel, tourism, and hospitality experiences. ",
    image: nyungwe1,
  },
  {
...
export const AccommodationsStatic = {
  houseRules: [
    {

  ...
  return (
    <div className="w-full h-screen relative flex items-center justify-center">
      ...
      <div className="relative flex-col gap-3 flex items-center justify-center bg-white/90 p-10 rounded-lg shadow-lg">
        ...
        <h2 className="text-center uppercase text-primaryGreen font-bold text-3xl">
          Oops! Page Not Found
        </h2>
        ...
        <Link href="/">
          <button className="hover:bg-primaryGreen hover:text-white duration-300 transition cursor-pointer px-5 py-2 rounded-full text-center border-primaryGreen border">
            Return Home
          </button>
        </Link>
      </div>
